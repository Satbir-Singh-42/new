...
- 2025-09-11: **PRICING SYSTEM OVERHAUL** - Completely eliminated all cent-based conversions from the application
- 2025-09-11: **DATABASE SCHEMA UPDATED** - Changed from price_per_kwh_cents to price_per_kwh_rupees column
- 2025-09-11: **FRONTEND CONVERSION REMOVED** - Removed all × 100 and ÷ 100 price conversions in dashboard.tsx and storage-page.tsx
- 2025-09-11: **BACKEND SIMPLIFICATION** - Updated server routes and storage to work directly with rupee values
