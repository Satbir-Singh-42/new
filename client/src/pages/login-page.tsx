        ...
        <div className="hidden md:flex flex-col justify-center space-y-4 sm:space-y-6 p-4 sm:p-6 lg:p-8 order-1 md:order-2">
          <div className="space-y-3 sm:space-y-4">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed">
              Unlock personalized features and save your solar analysis progress with a free account.
            </p>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="text-sm sm:text-base font-semibold text-gray-800">Save Your Analysis History</h3>
                <p className="text-xs sm:text-sm text-gray-600">Access your past installation plans and fault detection reports anytime</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="text-sm sm:text-base font-semibold text-gray-800">Personalized Recommendations</h3>
                <p className="text-xs sm:text-sm text-gray-600">Get AI suggestions tailored to your project preferences and history</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-600">Your analysis data is safely stored and accessible across devices</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="text-sm sm:text-base font-semibold text-gray-800">Chat History Persistence</h3>
                <p className="text-xs sm:text-sm text-gray-600">Continue AI conversations where you left off with saved chat history</p>
              </div>
            </div>
          </div>
