...
import { Bot, Send, X, Minimize2, Mic, MicOff, Copy, MessageCircle } from 'lucide-react';
    ...
    <div className="fixed bottom-4 right-4 z-[9999]">
      ...
      {isOpen && (
        <div className="absolute bottom-16 right-0 mb-2" ref={widgetRef}>
          <Card className={`w-[calc(100vw-2rem)] max-w-sm md:max-w-md lg:max-w-lg transition-all duration-300 h-[70vh] max-h-96 md:max-h-[500px] shadow-2xl drop-shadow-lg rounded-lg`}>
