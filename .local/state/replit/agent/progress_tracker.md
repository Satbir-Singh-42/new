...
[x] 16. Created centralized tournament rules configuration - max squad size (15), max foreign players (7), and qualifying teams (8) now easily manageable in one config file; budget and min players come from Google Sheet